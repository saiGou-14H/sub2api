...
const (
	HTTPUpstreamProfileCodexHarvest HTTPUpstreamProfile = "codex_harvest"
...
func HTTPUpstreamProfileFromContext(ctx context.Context) HTTPUpstreamProfile {
	...
	switch profile {
	case HTTPUpstreamProfileOpenAI, HTTPUpstreamProfileGrok, HTTPUpstreamProfileLongStream, HTTPUpstreamProfileCodexHarvest:
		return profile
	default:
		return HTTPUpstreamProfileDefault
	}
