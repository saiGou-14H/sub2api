...
func (r RunnerRequest) decodeOperation() (Operation, error) {
	...
	case "file_read", "file_write", "file_list", "file_skill_read_file", "file_skill_list_packages", "file_project_overview", "file_write_project_file":
...
func knownDeferredKind(k string) bool {
	...
	case "run_internal_posix_script", "start_job", "start_validation_job", "start_process_job", "start_detached_process_job", "start_script_job", "stop_job",
		"file_delete_project_files", "file_apply_text_edits", "file_apply_patch", "file_save_project_artifact", "file_read_project_artifact_metadata", "file_read_project_artifact", "file_read_project_artifact_export_chunk", "file_artifact_upload_begin", "file_artifact_upload_chunk", "file_artifact_upload_finish", "file_artifact_upload_abort", "file_checkpoint_create", "file_checkpoint_restore",
