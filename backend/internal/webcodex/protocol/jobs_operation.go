...
func (r RunnerRequest) DecodeJobInvocation() (JobInvocation, error) {
	...
	if r.Kind != "start_process_job" && r.Kind != "stop_job" {
		switch r.Kind {
		case "run_shell", "run_process", "run_script", "file_read", "file_write", "file_list", "file_skill_read_file", "file_skill_list_packages", "file_project_overview", "file_write_project_file", "file_delete_project_files":
