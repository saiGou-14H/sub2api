...
func TestApplyTextEditsGenericSelectorRequirements(t *testing.T) {
	...
	cases := []struct {
		...
		{"serde_overflow_selector", `{"changes":[{"edits":[{"line_scope":{},"occurrence":1e400}]}]}`, false, false},
		{"serde_overflow_unknown", `{"bad":-1e400,"changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_overflow_overwritten", `{"bad":1e400,"bad":0,"changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_lone_high_surrogate", `{"bad":"\ud800","changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_lone_low_surrogate", `{"bad":"\udfff","changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_unpaired_high_surrogate", `{"bad":"\ud800\u0041","changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_surrogate_key", `{"\ud800":0,"changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_surrogate_overwritten", `{"bad":"\ud800","bad":"ok","changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_valid_surrogate_pair", `{"ok":"\ud83d\ude00","changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
		{"serde_escaped_surrogate_literal", `{"ok":"\\ud800","changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
		{"serde_valid_replacement_character", `{"ok":"\ufffd","changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
		{"serde_finite_exponent", `{"ok":1e308,"changes":[{"edits":[{"line_scope":{},"occurrence":1}]}]}`, true, true},
		{"serde_zero_overflow_exponent", `{"ok":0e400,"changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
		{"serde_underflow_exponent", `{"ok":1e-400,"changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
		{"serde_too_deep", `{"extra":` + strings.Repeat(`[`, 127) + `0` + strings.Repeat(`]`, 127) + `,"changes":[{"edits":[{"line_scope":{}}]}]}`, false, false},
		{"serde_depth_boundary", `{"extra":` + strings.Repeat(`[`, 126) + `0` + strings.Repeat(`]`, 126) + `,"changes":[{"edits":[{"line_scope":{}}]}]}`, true, false},
