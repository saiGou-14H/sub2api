export default {
    accounts: {
      ...
      openai: {
        ...
        webTestModelLabel: 'Web test model',
        webTestModelHint: 'Choose a ChatGPT Web model. These selectors are separate from the Codex model catalog.',
        webTestPromptLabel: 'Web test prompt',
        webTestPromptPlaceholder: 'Example: Reply with OK only',
        webTestPromptDefault: 'Reply with OK only',
        webTestPromptHint: 'Sends a custom prompt through the ChatGPT Web conversation endpoint.',
        webTestMode: 'Mode: ChatGPT Web conversation',
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: 'Paste an OpenAI web access token to create a setup-token account that uses only this token. No refresh token is executed or stored.',
          accessTokenInputLabel: 'OpenAI access token',
          accessTokenPlaceholder: 'Paste access token',
          accessTokenHint: 'Requests use the ChatGPT/Codex web protocol. The server stores the token securely; do not log or share it.',
          accessTokenImportAndCreate: 'Create setup-token account',
          accessTokenEmpty: 'Please enter an OpenAI access token',
          accessTokenImportFailed: 'Failed to create access-token account',
