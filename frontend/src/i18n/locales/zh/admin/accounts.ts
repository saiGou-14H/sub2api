export default {
    accounts: {
      ...
      openai: {
        ...
        webTestModelLabel: '网页端测试模型',
        webTestModelHint: '请选择 ChatGPT 网页端模型；该目录与 Codex 模型目录相互独立。',
        webTestPromptLabel: '网页端测试提示词',
        webTestPromptPlaceholder: '例如：请只回复 OK',
        webTestPromptDefault: '请只回复 OK',
        webTestPromptHint: '通过 ChatGPT 网页端对话接口发送自定义提示词。',
        webTestMode: '模式：ChatGPT 网页端对话',
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: '直接输入 OpenAI 网页 access token，创建仅使用该令牌的 setup-token 账号。不会执行或保存 refresh token。',
          accessTokenInputLabel: 'OpenAI access token',
          accessTokenPlaceholder: '粘贴 access token',
          accessTokenHint: '该账号使用 ChatGPT/Codex 网页协议转发；令牌由服务端安全保存，请勿写入日志或分享。',
          accessTokenImportAndCreate: '创建 setup-token 账号',
          accessTokenEmpty: '请输入 OpenAI access token',
          accessTokenImportFailed: '创建 access token 账号失败',
